...
$(function(){
  ...
  window.onhashchange = function(){
    ...
    $.getJSON(apiURL,{q:q,rsz:4,start:0},function(r){
      ...
      {
        $(".public-search-results").html("<div class='no-search-result'>Start searching things you might buy in future, or things you already have, and share with your friends and family.</div>");
      }
    });
  };
